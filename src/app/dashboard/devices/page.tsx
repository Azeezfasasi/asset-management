...
export default function DevicesPage() {
  ...
  const allStatuses = ['In Store', 'Active', 'In-Repair', 'Transferred', 'Lost', 'Damaged', 'Archived'];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center">
        ...
        <select
          ...
          className="rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-900 shadow-sm"
        >
