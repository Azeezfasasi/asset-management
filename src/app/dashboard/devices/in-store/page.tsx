...
export default function InStorePage() {
  ...
  return (
    <div className='space-y-6'>
      <PageHeader title='Devices In Store' description='Assets in inventory that have not yet been assigned.' backHref='/dashboard/devices' action={{ label: 'Add Device', href: '/dashboard/devices/add' }} />
